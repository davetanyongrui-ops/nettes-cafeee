...
export default async function MenuView({ isEditable = false }: Props) {
    ...
    return (
        <MenuClient
            ...
            subtitle={getSetting(s, 'menu_subtitle', 'House-made daily. Wholesome ingredients. Eat-in or takeaway.')}
            titleKey="menu_title"
